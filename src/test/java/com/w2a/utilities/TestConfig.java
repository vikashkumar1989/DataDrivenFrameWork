...
public class TestConfig{
	...
	public static String from = "smartyvik35@gmail.com";
	public static String password = "lohani@123";
	public static String[] to ={"vikashkumar.101289@gmail.com","vikashkumar.1989@hotmail.com"};
